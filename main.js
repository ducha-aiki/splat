let cameras = [
    {
        ...
        height: 768,
        position: [
             0.0194, -0.2585,  0.0134,
            //   -0.2,0.0,0,
        ],
        rotation: [
        [ 0.9715,  0.0773,  0.2242],
        [-0.2299,  0.0746,  0.9704],
        [ 0.0582, -0.9942,  0.0902]
       //     [0, 0, 1 ],
       //     [-1, 0, 0 ],
       //     [0, -1, 0],
        ],
...
let defaultViewMatrix = [
    ...
    // 0,-1,0,0,
    // 0,0,0,1
    0.9715,  0.0773,  0.2242,  0.0194, -0.2299,  0.0746,  0.9704, -0.2585,
    0.0582, -0.9942,  0.0902,  0.0134,  0.0000,  0.0000,  0.0000,  1.0000
];
...
async function main() {
    ...
    const frame = (now) => {
        ...
        //     if (shiftKey) {
        //         inv = translate4(inv, 0, -shift_step_size, 0);
        //     } else {
        //         inv = translate4(inv, 0, 0, step_size);
        //     }
        // }
        ...
        //     inv = translate4(inv, -shift_step_size, 0, 0);
        // //
